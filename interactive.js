...
var welcometxt = document.getElementsByClassName('txt')
...
function todarkmode(){
    ...
    welcometxt[0].style.color = 'white';
    welcometxt[1].style.color = 'white';
    //hover properties
...
function towhitemode(){
    ...
    welcometxt[0].style.color = 'black';
    welcometxt[1].style.color = 'black';
    //hover properties
